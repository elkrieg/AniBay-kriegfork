...
proc/ShareRatio(datum/gas_mixture/A, datum/gas_mixture/B, connecting_tiles)
	...
	var
		...
		s_full_plasma = B.plasma * share_size
	...
	A.plasma = max(0, (A.plasma - plasma_avg) * (1-ratio) + plasma_avg )
	...
	B.plasma = max(0, (B.plasma - plasma_avg) * (1-ratio) + plasma_avg )
